...
| [operativa/DIRECTAS.md](operativa/DIRECTAS.md) | Reservas directas a exhuéspedes: fórmula de paridad (descuento = comisión de canal), términos de pago y plantilla del mensaje. Leer antes de cotizar por WhatsApp. |
