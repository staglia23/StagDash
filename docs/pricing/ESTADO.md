...
| **03/09/2026 05:15 UTC** | Hueco Magnoli (objetivo: vender lo más caro posible para que Magnoli pague menos del 50 % pactado), escalón 2: ALEX 07–08/09 suelos 161/173 → **145/155**. **AUTOMATIZADO** → `trig_01XhA7Bnb22zsjcnJ5ZNCd7A` |
| **05/09/2026 05:15 UTC** | Escalón 3 (D−2): se QUITA el suelo (delete + recreate solo con `min_stay 2`) → manda el mínimo del anuncio 129. **Suelo definitivo, no se baja más.** → `trig_01XgJ56kELgbaSp1HZSt78oV` |
| **06/09/2026 05:15 UTC** | Escalón 4 (D−1, último): `min_stay` 2→**1**, sin tocar precio. → `trig_01Ugf4RGSXB5BGpG8cJ5w5KJ` |
| **09/09/2026** | Medir el caso Magnoli (BITACORA 29/08, bloques 30 y 31/08): vendida o no, escalón, precio, lead, canal — **y cuánto acabó pagando Magnoli de penalidad** (137,50 si no se vendió). Cerrar la entrada y ajustar PLAYBOOK §4.8 con lo aprendido. Primer dato prospectivo del detector de noches liberadas (plan de automatización guardado en memoria, para ejecutar más adelante) |
