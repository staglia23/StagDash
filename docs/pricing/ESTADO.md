...
| **Diario 05:15 UTC hasta el 08/09** | **Piloto diario del hueco Magnoli** (ALEX 07–08/09): lee estado + demanda, aplica la curva 161/173 → 157/168 → 152/163 → 145/155 → 138/147 → 132/140 → 129/129, con HOLD si la demanda sube y aceleración si baja. Suelo duro **129**. min-stay 2 hasta el 05/09, 1 desde el 06/09. → routine `trig_01Cfm7KUw5A1GV1rTvNp4WX6`. Los tres one-shots (`trig_01XhA7…`, `trig_01XgJ5…`, `trig_01Ugf4…`) quedaron DESHABILITADOS |
