...
| **06/09/2026 05:15 UTC** | Hueco Magnoli, red final (D−1): `min_stay` 2→**1** en 07–08/09 de ALEX, reenviando el objeto completo con el `price` fijo 110 de cortesía (decisión Stag 31/08). **AUTOMATIZADO** → routine `trig_01Ugf4RGSXB5BGpG8cJ5w5KJ`. Las routines del 02/09 y 04/09 quedaron DESHABILITADAS ("CANCELADA 31/08") |
